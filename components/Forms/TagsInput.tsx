...
const TagsInput = ({
  ...
  return (
    <div className="space-y-2">
      ...
      <Input
        type="text"
        className="input bg-background! border-3 border-secondary dark:border-border shadow-lg dark:focus-visible:border-ring dark:focus-visible:ring-ring/50 dark:focus-visible:ring-[3px] dark:aria-invalid:border-destructive dark:aria-invalid:shadow-none"
        id="tags"

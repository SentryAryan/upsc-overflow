...
const PopularCard = ({
  ...
  const metricsInfo: MetricsInfo[] = [
    {
      ...
      value:
        popularCardType === "tags"
          ? tagWithMetrics?.numberOfQuestions || 0
          : subjectWithMetrics?.numberOfQuestions || 0,
      label: "questions",
    ...
    },
    {
      ...
      value:
        popularCardType === "tags"
          ? tagWithMetrics?.numberOfAnswers || 0
          : subjectWithMetrics?.numberOfAnswers || 0,
      label: "answers",
      color: "text-secondary-foreground",
    },
    {
      ...
      value:
        popularCardType === "tags"
          ? tagWithMetrics?.numberOfComments || 0
          : subjectWithMetrics?.numberOfComments || 0,
      label: "comments",
      color: "text-secondary-foreground",
    },
    {
      icon: popularCardType === "tags" ? Book : Hash,
      value:
        popularCardType === "tags"
          ? tagWithMetrics?.uniqueSubjects.length || 0
          : subjectWithMetrics?.uniqueTags.length || 0,
      label: popularCardType === "tags" ? "subjects" : "tags",
      color: "text-secondary-foreground",
    },
  ];
  ...
  return (
    <div
      ...
      onClick={() =>
        router.push(
          `/${popularCardType === "tags" ? "tags" : "subjects"}?${
            popularCardType === "tags"
              ? `tag=${encodeURIComponent(tagWithMetrics?.tag || "")}`
    ...
    >
      ...
      {/* Subjects section with fixed height */}
      {popularCardType === "subjects" && (
        <div className="min-h-[40px] mb-4 relative">

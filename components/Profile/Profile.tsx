      ...
      {isLoading ? (
        ...
        <div className="w-full">
          ...
          <div className="flex items-start justify-between">
            ...
            <Spotlight className="-top-160 left-0" fill="#1c9cf0" />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-8">
            ...
            <MetricCard
              ...
              Icon={metrics.netVotes > 0 ? TrendingUp : TrendingDown}
      ...
      {items.length === 0 ? (
        ...
        <ul className="space-y-3">
          {items.map((item, idx) => (
            <li
              key={idx}
              className="flex flex-col sm:flex-row items-start justify-between gap-4 p-3 rounded-md border-mode shadow-2xl hover:scale-[0.99] transition-all duration-200 cursor-pointer"
            ...
            >
              <div className="flex-1">
                ...
                <p className="text-muted-foreground text-xs mt-0.5 line-clamp-1 font-[900]">
                  {item.secondary}
                </p>
              </div>
              <span className="text-muted-foreground text-xs whitespace-nowrap font-[900]">
                {item.date}
              </span>
            </li>
          ))}

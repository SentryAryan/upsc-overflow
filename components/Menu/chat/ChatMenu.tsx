          ...
          <FloatingActionPanelContent>
            {mode === "actions" ? (
              <div className="flex flex-col justify-center items-center gap-6 p-4">
                <p className="text-lg font-[900] text-foreground">
                  Total Chats: {chatTabs.length}
                </p>
                ...
                {/* Chat Tabs */}
                <ScrollArea className="h-72 w-full overflow-hidden always-show-scrollbar flex flex-col justify-center items-center gap-6 p-4 rounded-md border-2 border-border always-show-scrollbar!">
